<?php
    class Students_Tables_DeletedStudentsTable{
        ...
        static private function getTable(){
            return HTML::Table(self::getTableHeader().self::getTableData(), 'students_overview_table', 'table highlight');
        }
        ...
        static private function getTableData(){
            ...
            foreach($records_ar as $record){
                ...
                $tmp_td_ar[] = HTML::Td(($record->has_rental_equipment ? FontAwesome::Icon('check', 2) : FontAwesome::Icon('times', 2)));
        ...
        static private function getJquery(){
            ...
            $(document).ready(function(){
                var students_table = $('#students_overview_table').DataTable({
