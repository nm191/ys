<?php
    class DB_Trainings_ExerciseTypes{

        static public function getList(){
            $sql_ar[] = 'SELECT id, description FROM '.DB_Trainings_TbNames::EXERCISE_TYPES;
        ...
        static public function getFullRecords(array $filter_ar = array()){
            ...
            $sql_ar[] = 'LEFT JOIN '.DB_Trainings_TbNames::EXERCISE_TYPES.' grps';
