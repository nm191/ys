<?php
    class TrainingGenerator_Tabmenu{
        static public function get($current_page_name){
            ...
            foreach($page_names_ar as $page_name => $title){
                ...
                $tmp_tab_ar[] = '<a class="nav-link'.($page_name == $current_page_name ? ' active' : '').'" href="http://'.PUBLIC_ROOT.'traininggenerator/?page='.$page_name.'">'.$title.'</a>';
                $tmp_tab_ar[] = '<li class="nav-item">';
        ...
        static private function getPageNames(){
            $page_names_ar['generate_training'] = 'Genereer Training';
            $page_names_ar['add_training']      = 'Voeg training toe';
